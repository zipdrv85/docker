...
--------------------------------------------------------
   ...
   CREATE SEQUENCE XEDRM5.ES_STICK  MINVALUE 0 MAXVALUE 1295 INCREMENT BY 1 START WITH 646 NOCACHE  NOORDER  CYCLE;
	CREATE SEQUENCE XEDRM5.ES_VOLUME_HISTORY_STICK MINVALUE 0 MAXVALUE 1295 START WITH 1 INCREMENT BY 1 CYCLE;
...
--------------------------------------------------------
CREATE TABLE XEDRM5.ES_VOLUME_HISTORY
   (	
...
ALTER TABLE XEDRM5.ES_VOLUME_HISTORY ADD CONSTRAINT ES_VOLUME_HISTORY_PK PRIMARY KEY(es_id);
create index XEDRM5.ES_VOLUME_HISTORY_idx1 on XEDRM5.ES_VOLUME_HISTORY(es_date);
create index XEDRM5.ES_VOLUME_HISTORY_idx2 on XEDRM5.ES_VOLUME_HISTORY(es_deleted);
create index XEDRM5.ES_VOLUME_HISTORY_idx3 on XEDRM5.ES_VOLUME_HISTORY(es_volumeid);
