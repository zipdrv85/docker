...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0301','기본 근로시간제','A03',1,'Y','','','','A0301','기본 근로시간제');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010101','당직근무','A0101',1,'Y','','','','On_call','On call');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010102','예비군','A0101',2,'Y','','','','Reserve_Forces','Reserve Forces');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010103','민방위','A0101',3,'Y','','','','Go_to_remote_work_directly','민방위');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010106','파견','A0101',6,'Y','','','','A010106','파견');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0605','커피','A06',1,'Y','','','','A0605','커피');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A06','외출 종류','A',1,'Y','','','','A06','외출종류');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0601','외출','A06',1,'Y','','','','A0601','외출');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0802','미승인','A08',1,'Y','','','','A0802','Not Approved');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0102','부회장','P01',2,'Y','','','','P0102','부회장');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0107','상무보','P01',7,'Y','','','','P0107','상무보');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0109','이사대우','P01',9,'Y','','','','P0109','이사대우');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0121','촉탁(p)','P01',21,'Y','','','','P0121','촉탁(p)');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0111','부장','P01',11,'Y','','','','P0111','부장');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0115','사원','P01',15,'Y','','','','P0115','사원');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0606','식사','A06',1,'Y','','','','A0606','식사');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010105','교육(강사)','A0101',5,'N','','','','A010105','교육(강사)');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0304','간주 근로시간제','A03',4,'Y','','','','A0304','간주 근로시간제');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010207','출산휴가','A0102',7,'Y','','','','A010207','출산휴가');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0102','휴무','A01',2,'Y','','','','A0102','Closed');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0205','회수','A02',5,'N','','','','A0205','회수');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A01','HR결재','A',1,'Y','','','','A01','HR결재');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0114','대리','P01',14,'Y','','','','P0114','대리');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0108','이사','P01',8,'Y','','','','P0108','이사');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A05','요청 타입','A',1,'Y','','','',' A05',' 요청 타입');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0103','출장','A01',3,'Y','','','','A0103','Business trip');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0204','반려','A02',4,'Y','','','','A0204','반려');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0105','전무','P01',5,'Y','','','','P0105','전무');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0902','회의','A09',1,'Y','Y','','','A0902','Presence');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010202','반차(오전)','A0102',2,'Y','','','','A010202','반차(오전)');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0801','발송','A08',1,'Y','','','','A0801','To send');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0113','과장','P01',13,'Y','','','','P0113','과장');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A07','이메일유형','A',1,'Y','','','','A07','Email Type');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0101','근무','A01',1,'Y','','','','A0101','Work Type');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('P0119','인턴','P01',18,'Y','','','','P0119','인턴');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0105','연장근로','A01',5,'Y','','','','A0105','Overtime work');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0302','탄력적 근로시간제','A03',2,'Y','','','','A0302','탄력적 근로시간제');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010603','기간내 근무 정책 정정','A0106',1,'Y',NULL,NULL,NULL,'A010603','Temperary Policy modification');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A010605','기본 근무지 정정','A0106',1,'Y',NULL,NULL,NULL,'A010605','Default Workplace modification');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A090407','직접입력','A0904',1,'N','N','','','A090407','Presence');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A0905','자리비움(인정)','A09',1,'Y','N','','','A0905','Presence');
...
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A090402','화장실','A0904',1,'Y','N','','','A090402','Presence');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A090403','흡연','A0904',1,'Y','N','','','A090403','Presence');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A090405','커피','A0904',1,'Y','N','','','A090405','Presence');
INSERT INTO sw_code (code_id,code_name,parent_code,code_order,use_yn,code_ref1,code_ref2,code_ref3,code_key,code_enm) VALUES ('A090408','점심','A0904',2,'Y','N',NULL,NULL,'A090408','Lunch');
...
INSERT INTO sw_workplace (user_id,work_place_nm,latitude,longitude,work_place_id,address) VALUES ('admin@inzent.com','본사',37.52361,126.92382,'COMPANY','대한민국 서울특별시 영등포구 여의도동 23-7');