...
-- Name: es_adhocauth; Type: TABLE; Schema: public; Owner: XEDRM5
--

CREATE TABLE public.es_adhocauth (
    elementid character(16) NOT NULL,
    userrole character varying(256) NOT NULL,
    privilege numeric(38,0),
    privilegetype numeric(38,0) NOT NULL,
...
-- Name: es_secureaccess; Type: TABLE; Schema: public; Owner: XEDRM5
--

CREATE TABLE public.es_secureaccess (
    secureclassid character(16) NOT NULL,
    roleid character(16) NOT NULL,
    priviledge numeric(38,0) NOT NULL,
    startdate timestamp without time zone,
    enddate timestamp without time zone
);
...
-- Name: es_secureaccessext; Type: TABLE; Schema: public; Owner: XEDRM5
--

CREATE TABLE public.es_secureaccessext (
    authmngrid character(16) NOT NULL,
    secureclassid character(16) NOT NULL,
    roleid character(32) NOT NULL,
    priviledge numeric(38,0) NOT NULL
);
...
-- Name: es_secureclass; Type: TABLE; Schema: public; Owner: XEDRM5
--

CREATE TABLE public.es_secureclass (
    secureclassid character(16) NOT NULL,
    descr character varying(64) NOT NULL,
    securetype numeric(38,0) NOT NULL,
    adminsclass character(16)
);
...
CREATE TABLE public.pol_list (
    ...
    policy_nm character varying(64),
    descr character varying(256),
    default_policy_yn character(1),
    use_yn character(1),
    policy_ymdtime character(14),
    chg_id character varying(256),
    chg_dt timestamp without time zone
...
--
-- TOC entry 3067 (class 2606 OID 17177)
-- Name: es_secureclass pk_essecureclass; Type: CONSTRAINT; Schema: public; Owner: XEDRM5
--

ALTER TABLE ONLY public.es_secureclass
    ADD CONSTRAINT pk_essecureclass PRIMARY KEY (secureclassid);
...
ALTER TABLE ONLY public.pol_apply_user
    ADD CONSTRAINT xpk_pol_apply_user PRIMARY KEY (user_cl, user_id);
...
CREATE INDEX asysce_elementid ON public.asyscontentelement USING btree (elementid);
